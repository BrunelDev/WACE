...
export function SummaryCard1({ icon, title }) {
  return (
    <div className="max-w-[450px] mb-3 bg-white rounded-lg p-3 text-gray-400">
...
export function SummaryCard2({ icon, title, content }) {
  return (
    <div className="w-[450px] mb-4 bg-white rounded-lg p-3 text-gray-400">
      <div className="flex justify-between mb-8">
        <div className="p-1 bg-[#f0e3d4] rounded-md">
          {icon}
          {title ? title : null}
