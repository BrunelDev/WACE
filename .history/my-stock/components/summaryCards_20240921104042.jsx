...
export function SummaryCard1({ icon, title }) {
  return (
    <div className="max-w-[450px] mb-3 bg-white shadow-md rounded-lg p-3 text-gray-400">
...
export function SummaryCard2({ icon, iconBg, title, content }) {
  return (
    <div className="w-[450px] mb-4 bg-white rounded-lg shadow-md p-3 text-gray-400">
      <div className="flex justify-between mb-8">
