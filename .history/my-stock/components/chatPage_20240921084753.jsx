...
export function ConversationListContainer() {
  return (
    <div>
      <div className="bg-white w-[100%] h-[75vh] rounded-md shadow-md px-4 pt-3 overflow-hidden">
...
export function MessagesContainer() {
  ...
  return (
    <div className="bg-white w-[70%] h-[75vh] rounded-md shadow-md px-4 pt-3 overflow-hidden">
      <MessageList
        style={{ height: "500px" }}
