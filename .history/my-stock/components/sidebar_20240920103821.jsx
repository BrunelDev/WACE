  ...
  return (
    <div className="flex fixed top-0 left-0  flex-col justify-center items-center space-y-4 px-5 w-[100px] bg-white rounded-md h-[100vh]">
      <div className="flex flex-col space-y-10">
        ...
        <span
          className={`p-2 ${
            isUsersSelected ? "bg-blue-600 scale-110" : null
          } bg-blue-600 scale-110 duration-200 hover:bg-gray-200 w-fit rounded-md hover:scale-110`}
        >
          <Users
        ...
        <span
          className={`p-2 ${
            isInventorySelected ? "bg-blue-600 scale-110" : null
          } bg-blue-600 scale-110 duration-200 hover:bg-gray-200 w-fit rounded-md hover:scale-110`}
        >
          <Folder
            onClick={() => {
        ...
        <span
          className={`p-2 ${
            isConversationsSelected ? "bg-blue-600 scale-110" : null
          } bg-blue-600 scale-110 duration-200 hover:bg-gray-200 w-fit rounded-md hover:scale-110`}
        >
          <MessageSquareMore
            onClick={() => {
        ...
        <span
          className={`p-2 ${
            isSettingsSelected ? "bg-blue-600 scale-110" : null
          } bg-blue-600 scale-110 duration-200 hover:bg-gray-200 w-fit rounded-md hover:scale-110`}
        >
          <Settings
            onClick={() => {
