...
const ProductCard = ({
  ...
  return (
    <div className="max-w-[300px] rounded overflow-hidden shadow-lg hover:scale-[1.03] duration-200 bg-white flex flex-col justify-center items-center px-4 py-4">
      <Image
        width={300}
        height={200}
