...
export function Storepage() {
  ...
  return (
    <div className="">
      {data.map(
        (product: { image: string; nom: string; description: string }, i) => {
          return (
            <div key={i}>
              <ProductCard
                image={product.image}
                productName={product?.nom ? product?.nom : null}
...
const ProductCard = ({ image, productName, description, category, id }) => {
  return (
