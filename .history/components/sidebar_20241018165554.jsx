...
export function Sidebar() {
  ...
  return (
    <div
      className={`flex fixed top-0 left-0  flex-col pt-5 items-center px-5 transition-transform duration-1000 ease-in-out ${
        expanded ? "w-fit" : "w-[80px]"
      }  bg-white rounded-md h-[100vh]`}
      onClick={() => {
